        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfile_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessibilityFeatures_CompanyProfile_CompanyProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Requirments = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    WorkingModel = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jops", x => x.JopId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Jops_CompanyProfile_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfile",
                        principalColumn: "CompanyProfileId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_userReactions", x => x.ReactionId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "PostId");
                    table.ForeignKey(
                        name: "FK_userReactions_reactionTypes_ReactionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyEmployees_CompanyProfile_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfile",
                        principalColumn: "CompanyProfileId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyEmployees_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyReviews_CompanyProfile_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfile",
                        principalColumn: "CompanyProfileId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyReviews_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MillStones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MillStones_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_userCertifications_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_userProfilePictures_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JopApplyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FullName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CvFile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnyComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    JopId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JopApplies", x => x.JopApplyId);
                    table.ForeignKey(
                        name: "FK_JopApplies_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JopApplies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JopApplies_Jops_JopId",
                        column: x => x.JopId,
                        principalTable: "Jops",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessibilityFeatures_CompanyProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyEmployees_CompanyProfileId",
                table: "CompanyEmployees",
                column: "CompanyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyEmployees_UserProfileId",
                table: "CompanyEmployees",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfile_ApplicationUserId",
                table: "CompanyProfile",
                column: "ApplicationUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CompanyReviews_CompanyProfileId",
                table: "CompanyReviews",
                column: "CompanyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyReviews_UserProfileId",
                table: "CompanyReviews",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JopApplies_ApplicationUserId",
                table: "JopApplies",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_JopApplies_JopId",
                table: "JopApplies",
                column: "JopId");

            migrationBuilder.CreateIndex(
                name: "IX_JopApplies_UserId",
                table: "JopApplies",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Jops_CompanyProfileId",
                table: "Jops",
                column: "CompanyProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MillStones_UserProfileId",
                table: "MillStones",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_userCertifications_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_userReactions_ReactionTypeId",
                table: "userReactions",
